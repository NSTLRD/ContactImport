...
public class EmpleadoExporterPDF {
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Empleado empleado : listaEmpleados) {
			...
			tabla.addCell(empleado.getName());
			tabla.addCell(empleado.getEmail());
			tabla.addCell(empleado.getDateofbirth().toString());
			tabla.addCell(String.valueOf(empleado.getPhone()));
			tabla.addCell(empleado.getCreditcard());
			tabla.addCell(empleado.getCreditcardnetwork());
			tabla.addCell(String.valueOf(empleado.getAddress()));
		}
	}
