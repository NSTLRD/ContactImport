...
public class EmpleadoExporterExcel {
	...
	private void escribirDatosDeLaTabla() {
		...
		for(Empleado empleado : listaEmpleados) {
			...
			celda = fila.createCell(1);
			celda.setCellValue(empleado.getName());
			...
			celda = fila.createCell(3);
			celda.setCellValue(empleado.getDateofbirth().toString());
			hoja.autoSizeColumn(3);
			celda.setCellStyle(estilo);
			
			celda = fila.createCell(4);
			celda.setCellValue(empleado.getPhone());
			hoja.autoSizeColumn(4);
			celda.setCellStyle(estilo);
			
			celda = fila.createCell(5);
			celda.setCellValue(empleado.getCreditcard());
			hoja.autoSizeColumn(5);
			celda.setCellStyle(estilo);

			celda = fila.createCell(6);
			celda.setCellValue(empleado.getCreditcardnetwork());
			hoja.autoSizeColumn(6);
			celda.setCellStyle(estilo);
			
			celda = fila.createCell(7);
			celda.setCellValue(empleado.getAddress());
